...
category: patents
permalink: /publication/patent-p4-log-templates
excerpt: 'U.S. patent application (2024) — Application No. US20260030134A1. Determines log templates from computing-device logs to drive efficient and accurate log templatization for downstream analytics.'
date: 2024-06-03
...
Determines log templates from computing-device logs to drive efficient and accurate log templatization for downstream analytics.
