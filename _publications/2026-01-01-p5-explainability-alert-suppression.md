...
category: patents
permalink: /publication/patent-p5-explainability-alert-suppression
excerpt: 'U.S. Patent No. US12536061B1 (granted 2026). Uses explainability signals to guide runtime control of an alert-suppression policy, tying each suppression decision to the evidence that supports it.'
date: 2026-01-01
...
Uses explainability signals to guide runtime control of an alert-suppression policy, tying each suppression decision to the evidence that supports it.
